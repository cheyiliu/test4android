...
public class FragmentMetro3 extends Fragment {
    private static int ROWS = 1;// TODO to test, change this value
    ArrayList<ItemInfo> mItemInfos = new ArrayList<ItemInfo>();

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.lib_metro_sample2_fragment3, null);
        generateMetroItems();
