...
public class MainActivity extends Activity implements OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.renren_slidemenu_activity_main);
        initValues();
    ...
    private void log() {
        Log.e("test", "["
                + ", gravity=" + menuParams.gravity
                + ", bottomMargin=" + menuParams.bottomMargin
                + ", leftMargin=" + menuParams.leftMargin
                + ", rightMargin=" + menuParams.rightMargin
                + ", topMargin=" + menuParams.topMargin
                + ", weight=" + menuParams.weight
